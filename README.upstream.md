...
> [!NOTE]
> This file preserves the upstream project documentation as a reference. It does not describe all Material 3 UI, native multi-browser manager, backup/WebDAV, update, or Xiaomi Browser changes in this fork. See the current [fork README](README.md) for maintained documentation.
